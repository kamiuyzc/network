...
void y_getsockaddr(const struct sockaddr_in clin_addr, char * clin_ip_ptr, int * clin_port_ptr)
{
	inet_ntop(AF_INET, &clin_addr.sin_addr.s_addr, clin_ip_ptr, INET_ADDRSTRLEN);
	*clin_port_ptr = ntohs(clin_addr.sin_port);
}
